...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String text = "Learning Android on Udacity";
        shareText(text);
    ...
    private void shareText(String text){
        String title = "Learning how to share data";
        String mimeType = "text/plain";        // TODO (6) Replace the Toast with shareText, passing in the String from step 5
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if(requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK){
            ...
            passData(imageBitmap);
        }
    }

    private void passData(Bitmap image){
        ByteArrayOutputStream bs = new ByteArrayOutputStream();
        image.compress(Bitmap.CompressFormat.PNG, 50, bs);
        Context context = MainActivity.this;
        Class destinationActivity = PhotoActivity.class;

        Intent photoActivityIntent = new Intent(context, destinationActivity);
        photoActivityIntent.putExtra("byteArray", bs.toByteArray());
        if(photoActivityIntent.resolveActivity(getPackageManager()) != null){
